...
data/allowed_ext_idefs.json:
	python3 wikidatarefisland/run.py --step ss1 --output "allowed_ext_idefs.json"
data/extracted_unreferenced_statements.jsonl: \
	data/allowed_ext_idefs.json
	python3 wikidatarefisland/run.py --step extract_items --side-service-input "allowed_ext_idefs.json" --dump-path "${DUMP_PATH}" --output "extracted_unreferenced_statements.jsonl"
...
data/matched_item_references.jsonl: \
	data/scraped_data.jsonl
	python3 wikidatarefisland/run.py --step item_analysis --input "scraped_data.jsonl" --side-service-input "allowed_ext_idefs.json" --output "matched_item_references.jsonl"
